...
#pragma warning disable IDE0052
		private static readonly ObservableGauge<long> InFlightGauge = Meter.CreateObservableGauge<long>(
			"ukho.pipeline.node.inflight",
			ObserveInFlight);

		private static readonly ObservableGauge<long> QueueDepthGauge = Meter.CreateObservableGauge<long>(
...
#pragma warning restore IDE0052
		...
		public void Dispose()
		{
			InFlightProviders.TryRemove(nodeName, out _);
			QueueDepthProviders.TryRemove(nodeName, out _);
		}
