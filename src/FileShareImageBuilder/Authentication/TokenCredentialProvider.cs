...
public class TokenCredentialProvider : IAuthenticationTokenProvider
{
    ...
    public TokenCredentialProvider(TokenCredential credential, IEnumerable<string> scopes, TimeSpan? refreshSkew = null)
    {
